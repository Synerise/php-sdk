...
class TrackingCodeCreationByDomainRequest implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new TrackingCodeCreationByDomainRequest and sets the default values.
    */
     ...
     * @return TrackingCodeCreationByDomainRequest
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): TrackingCodeCreationByDomainRequest {
        return new TrackingCodeCreationByDomainRequest();
    }
