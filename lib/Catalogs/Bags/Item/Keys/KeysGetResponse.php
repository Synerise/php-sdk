...
class KeysGetResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<string>|null $data A list of keys (column names) in the catalog
    */
    ...
    */
    ...
    /**
     * Instantiates a new KeysGetResponse and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): KeysGetResponse {
    ...
    */
    ...
    /**
     * Gets the data property value. A list of keys (column names) in the catalog
    ...
    */
    ...
    /**
     * Sets the data property value. A list of keys (column names) in the catalog
     * @param array<string>|null $value Value to set for the data property.
    */
