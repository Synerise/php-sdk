...
class WithCatalogDeleteResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var bool|null $data `true` if the catalog was deleted successfully
    */
    ...
    */
    ...
    /**
     * Instantiates a new WithCatalogDeleteResponse and sets the default values.
    */
     ...
     * @return WithCatalogDeleteResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): WithCatalogDeleteResponse {
        return new WithCatalogDeleteResponse();
    }
    ...
    */
    ...
    /**
     * Gets the data property value. `true` if the catalog was deleted successfully
     * @return bool|null
    */
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'data' => fn(ParseNode $n) => $o->setData($n->getBooleanValue()),
    ...
    */
    ...
    /**
     * Sets the data property value. `true` if the catalog was deleted successfully
     * @param bool|null $value Value to set for the data property.
    */
    public function setData(?bool $value): void {
        $this->data = $value;
    }
