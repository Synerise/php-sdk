...
class WithItemKeyGetResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new WithItemKeyGetResponse and sets the default values.
    */
     ...
     * @return WithItemKeyGetResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): WithItemKeyGetResponse {
        return new WithItemKeyGetResponse();
    }
