...
class ByIdsPostResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ByIdsPostResponse and sets the default values.
    */
     ...
     * @return ByIdsPostResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ByIdsPostResponse {
        return new ByIdsPostResponse();
    }
