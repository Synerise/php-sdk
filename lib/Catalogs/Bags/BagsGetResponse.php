...
class BagsGetResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<Bag>|null $data A list of catalogs
    */
    ...
    */
    ...
    /**
     * Instantiates a new BagsGetResponse and sets the default values.
    */
     ...
     * @return BagsGetResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): BagsGetResponse {
        return new BagsGetResponse();
    }
    ...
    */
    ...
    /**
     * Gets the data property value. A list of catalogs
     * @return array<Bag>|null
    */
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'data' => fn(ParseNode $n) => $o->setData($n->getCollectionOfObjectValues([Bag::class, 'createFromDiscriminatorValue'])),
    ...
    */
    ...
    /**
     * Sets the data property value. A list of catalogs
     * @param array<Bag>|null $value Value to set for the data property.
    */
