...
*/
class AutocompleteRequestBuilderGetRequestConfiguration extends BaseRequestConfiguration 
{
    /**
     * @var AutocompleteRequestBuilderGetQueryParameters|null $queryParameters Request query parameters
    */
    public ?AutocompleteRequestBuilderGetQueryParameters $queryParameters = null;
    
    /**
     * Instantiates a new AutocompleteRequestBuilderGetRequestConfiguration and sets the default values.
     * @param array<string, array<string>|string>|null $headers Request headers
     * @param array<RequestOption>|null $options Request options
     * @param AutocompleteRequestBuilderGetQueryParameters|null $queryParameters Request query parameters
    */
    public function __construct(?array $headers = null, ?array $options = null, ?AutocompleteRequestBuilderGetQueryParameters $queryParameters = null) {
        parent::__construct($headers ?? [], $options ?? []);
        $this->queryParameters = $queryParameters;
    }

    /**
     * Instantiates a new AutocompleteRequestBuilderGetQueryParameters.
     ...
     * @return AutocompleteRequestBuilderGetQueryParameters
    */
    public static function createQueryParameters(?bool $caseSensitiveFacetValues = null, ?string $clientUUID = null, ?array $context = null, ?array $displayAttributes = null, ?string $distinctFilter = null, ?array $excludeQueryRules = null, ?array $facets = null, ?int $facetsSize = null, ?int $filterAroundRadius = null, ?array $filterGeoPoints = null, ?string $filters = null, ?bool $ignoreQueryRules = null, ?GetIncludeFacetsQueryParameterType $includeFacets = null, ?bool $includeMeta = null, ?int $limit = null, ?int $maxValuesPerFacet = null, ?GetOrderingQueryParameterType $ordering = null, ?int $page = null, ?bool $personalize = null, ?string $query = null, ?string $sortBy = null, ?string $sortByGeoPoint = null, ?GetSortByMetricQueryParameterType $sortByMetric = null): AutocompleteRequestBuilderGetQueryParameters {
        return new AutocompleteRequestBuilderGetQueryParameters($caseSensitiveFacetValues, $clientUUID, $context, $displayAttributes, $distinctFilter, $excludeQueryRules, $facets, $facetsSize, $filterAroundRadius, $filterGeoPoints, $filters, $ignoreQueryRules, $includeFacets, $includeMeta, $limit, $maxValuesPerFacet, $ordering, $page, $personalize, $query, $sortBy, $sortByGeoPoint, $sortByMetric);
    }
