...
class ExplainRequestBuilderGetQueryParameters 
{
    ...
    */
    public function __construct(?bool $caseSensitiveFacetValues = null, ?string $clientUUID = null, ?array $context = null, ?array $displayAttributes = null, ?string $distinctFilter = null, ?array $excludeQueryRules = null, ?array $facets = null, ?int $facetsSize = null, ?int $filterAroundRadius = null, ?array $filterGeoPoints = null, ?string $filters = null, ?bool $ignoreQueryRules = null, ?GetIncludeFacetsQueryParameterType $includeFacets = null, ?bool $includeMeta = null, ?int $limit = null, ?int $maxValuesPerFacet = null, ?GetOrderingQueryParameterType $ordering = null, ?int $page = null, ?bool $personalize = null, ?string $query = null, ?string $sortBy = null, ?string $sortByGeoPoint = null, ?GetSortByMetricQueryParameterType $sortByMetric = null) {
