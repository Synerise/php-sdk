...
*/
class ExplainPostResponse implements ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ExplainPostResponse {
        $result = new ExplainPostResponse();
        return $result;
    }
