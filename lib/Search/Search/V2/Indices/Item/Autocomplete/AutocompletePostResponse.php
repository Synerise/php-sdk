...
*/
class AutocompletePostResponse implements ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
     ...
     * @return AutocompletePostResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AutocompletePostResponse {
        $result = new AutocompletePostResponse();
        return $result;
    }
