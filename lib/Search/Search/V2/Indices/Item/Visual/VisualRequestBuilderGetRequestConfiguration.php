...
{
    /**
     * @var VisualRequestBuilderGetQueryParameters|null $queryParameters Request query parameters
    */
    public ?VisualRequestBuilderGetQueryParameters $queryParameters = null;
    
    /**
     * Instantiates a new VisualRequestBuilderGetRequestConfiguration and sets the default values.
     * @param array<string, array<string>|string>|null $headers Request headers
     * @param array<RequestOption>|null $options Request options
     * @param VisualRequestBuilderGetQueryParameters|null $queryParameters Request query parameters
    */
    public function __construct(?array $headers = null, ?array $options = null, ?VisualRequestBuilderGetQueryParameters $queryParameters = null) {
        parent::__construct($headers ?? [], $options ?? []);
        $this->queryParameters = $queryParameters;
    }

    /**
     * Instantiates a new VisualRequestBuilderGetQueryParameters.
     ...
     * @param string|null $filterAnchor Anchor (`{width},{height}`) by which the visual results data will be filtered.`{width},{height}` correspond to normalized image coordinates, i.e. they are in range [0,1].Anchor (0,0) corresponds to the top-left pixel of an image.
     ...
     * @param string|null $url URL of the image to be used in the visual search
     * @return VisualRequestBuilderGetQueryParameters
    */
    public static function createQueryParameters(?bool $caseSensitiveFacetValues = null, ?string $clientUUID = null, ?array $context = null, ?string $correlationId = null, ?array $displayAttributes = null, ?array $excludeQueryRules = null, ?array $facets = null, ?int $facetsSize = null, ?string $filterAnchor = null, ?int $filterAroundRadius = null, ?array $filterGeoPoints = null, ?string $filters = null, ?bool $ignoreQueryRules = null, ?GetIncludeFacetsQueryParameterType $includeFacets = null, ?bool $includeMeta = null, ?int $limit = null, ?int $maxValuesPerFacet = null, ?GetOrderingQueryParameterType $ordering = null, ?int $page = null, ?bool $personalize = null, ?string $searchId = null, ?string $sortBy = null, ?string $sortByGeoPoint = null, ?GetSortByMetricQueryParameterType $sortByMetric = null, ?string $url = null): VisualRequestBuilderGetQueryParameters {
        return new VisualRequestBuilderGetQueryParameters($caseSensitiveFacetValues, $clientUUID, $context, $correlationId, $displayAttributes, $excludeQueryRules, $facets, $facetsSize, $filterAnchor, $filterAroundRadius, $filterGeoPoints, $filters, $ignoreQueryRules, $includeFacets, $includeMeta, $limit, $maxValuesPerFacet, $ordering, $page, $personalize, $searchId, $sortBy, $sortByGeoPoint, $sortByMetric, $url);
    }
