...
class ListPostRequestBody implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ListPostRequestBody and sets the default values.
    */
     ...
     * @return ListPostRequestBody
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ListPostRequestBody {
        return new ListPostRequestBody();
    }
