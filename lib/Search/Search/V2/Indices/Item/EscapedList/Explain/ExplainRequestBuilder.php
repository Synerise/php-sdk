...
use Synerise\Api\Search\Models\ListingResponseWithExplanation;

/**
 * Builds and executes requests for operations under /search/v2/indices/{indexId}/list/explain
*/
class ExplainRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    ...
    /**
     * Retrieves item listing, which is a search without a query. The results can be filtered and sorted. The response contains search explanation.
     ...
     * @return Promise<ListingResponseWithExplanation|null>
     * @throws Exception
    */
    public function get(?ExplainRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [ListingResponseWithExplanation::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
