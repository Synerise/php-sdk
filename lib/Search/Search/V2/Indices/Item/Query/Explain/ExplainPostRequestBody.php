...
class ExplainPostRequestBody implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ExplainPostRequestBody and sets the default values.
    */
     ...
     * @return ExplainPostRequestBody
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ExplainPostRequestBody {
        return new ExplainPostRequestBody();
    }
