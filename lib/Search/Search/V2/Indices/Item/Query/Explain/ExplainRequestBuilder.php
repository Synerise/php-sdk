...
/**
 * Builds and executes requests for operations under /search/v2/indices/{indexId}/query/explain
*/
class ExplainRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    ...
    /**
     * Retrieves items that match a full-text query from a search index or a suggestion index. The results can be filtered and sorted.  The response contains search explanation.
    ...
    */
    public function toPostRequestInformation(ExplainPostRequestBody $body, ?ExplainRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = '{+baseurl}/search/v2/indices/{indexId}/query/explain';
        $requestInfo->pathParameters = $this->pathParameters;
