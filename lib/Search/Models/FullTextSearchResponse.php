...
class FullTextSearchResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<Query>|null $data A page of matching items as objects. The parameters of each item's object depend on the configuration of displayable attributes.
    */
    private ?array $data = null;
    
    /**
     * @var FullTextSearchResponse_extras|null $extras Additional information
    */
    private ?FullTextSearchResponse_extras $extras = null;
    ...
    */
    ...
    /**
     * Instantiates a new FullTextSearchResponse and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): FullTextSearchResponse {
    ...
    */
     ...
     * @return FullTextSearchResponse_extras|null
    */
    public function getExtras(): ?FullTextSearchResponse_extras {
        return $this->extras;
    }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'data' => fn(ParseNode $n) => $o->setData($n->getCollectionOfObjectValues([Query::class, 'createFromDiscriminatorValue'])),
            'extras' => fn(ParseNode $n) => $o->setExtras($n->getObjectValue([FullTextSearchResponse_extras::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @param array<Query>|null $value Value to set for the data property.
    */
     ...
     * @param FullTextSearchResponse_extras|null $value Value to set for the extras property.
    */
    public function setExtras(?FullTextSearchResponse_extras $value): void {
        $this->extras = $value;
    }
