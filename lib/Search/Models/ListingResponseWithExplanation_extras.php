...
*/
class ListingResponseWithExplanation_extras implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ListingResponseWithExplanation_extras and sets the default values.
    */
     ...
     * @return ListingResponseWithExplanation_extras
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ListingResponseWithExplanation_extras {
        return new ListingResponseWithExplanation_extras();
    }
