...
class Explain implements AdditionalDataHolder, Parsable 
{
    /**
     * @var PerItemExplanation|null $_explanation The _explanation property
    */
    private ?PerItemExplanation $_explanation = null;
    ...
    */
    ...
    /**
     * Instantiates a new Explain and sets the default values.
    */
     ...
     * @return Explain
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): Explain {
        return new Explain();
    }
    ...
    */
    ...
    /**
     * Gets the _explanation property value. The _explanation property
     * @return PerItemExplanation|null
    */
    public function getExplanation(): ?PerItemExplanation {
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            '_explanation' => fn(ParseNode $n) => $o->setExplanation($n->getObjectValue([PerItemExplanation::class, 'createFromDiscriminatorValue'])),
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        $writer->writeObjectValue('_explanation', $this->getExplanation());
    ...
    */
    ...
    /**
     * Sets the _explanation property value. The _explanation property
     * @param PerItemExplanation|null $value Value to set for the _explanation property.
    */
    public function setExplanation(?PerItemExplanation $value): void {
