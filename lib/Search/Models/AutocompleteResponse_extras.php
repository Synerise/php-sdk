...
*/
class AutocompleteResponse_extras implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new AutocompleteResponse_extras and sets the default values.
    */
     ...
     * @return AutocompleteResponse_extras
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AutocompleteResponse_extras {
        return new AutocompleteResponse_extras();
    }
