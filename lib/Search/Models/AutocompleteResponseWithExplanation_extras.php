...
*/
class AutocompleteResponseWithExplanation_extras implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new AutocompleteResponseWithExplanation_extras and sets the default values.
    */
     ...
     * @return AutocompleteResponseWithExplanation_extras
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AutocompleteResponseWithExplanation_extras {
        return new AutocompleteResponseWithExplanation_extras();
    }
