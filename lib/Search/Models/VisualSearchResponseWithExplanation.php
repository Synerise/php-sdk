...
class VisualSearchResponseWithExplanation implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var VisualSearchResponseWithExplanation_extras|null $extras Additional information
    */
    private ?VisualSearchResponseWithExplanation_extras $extras = null;
    ...
    */
    ...
    /**
     * Instantiates a new VisualSearchResponseWithExplanation and sets the default values.
    */
     ...
     * @return VisualSearchResponseWithExplanation
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): VisualSearchResponseWithExplanation {
        return new VisualSearchResponseWithExplanation();
    }
    ...
    */
     ...
     * @return VisualSearchResponseWithExplanation_extras|null
    */
    public function getExtras(): ?VisualSearchResponseWithExplanation_extras {
        return $this->extras;
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'extras' => fn(ParseNode $n) => $o->setExtras($n->getObjectValue([VisualSearchResponseWithExplanation_extras::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @param VisualSearchResponseWithExplanation_extras|null $value Value to set for the extras property.
    */
    public function setExtras(?VisualSearchResponseWithExplanation_extras $value): void {
        $this->extras = $value;
    }
