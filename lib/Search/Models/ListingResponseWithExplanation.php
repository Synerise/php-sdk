...
class ListingResponseWithExplanation implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var ListingResponseWithExplanation_extras|null $extras Additional information
    */
    private ?ListingResponseWithExplanation_extras $extras = null;
    ...
    */
    ...
    /**
     * Instantiates a new ListingResponseWithExplanation and sets the default values.
    */
     ...
     * @return ListingResponseWithExplanation
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ListingResponseWithExplanation {
        return new ListingResponseWithExplanation();
    }
    ...
    */
     ...
     * @return ListingResponseWithExplanation_extras|null
    */
    public function getExtras(): ?ListingResponseWithExplanation_extras {
        return $this->extras;
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'extras' => fn(ParseNode $n) => $o->setExtras($n->getObjectValue([ListingResponseWithExplanation_extras::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @param ListingResponseWithExplanation_extras|null $value Value to set for the extras property.
    */
    public function setExtras(?ListingResponseWithExplanation_extras $value): void {
        $this->extras = $value;
    }
