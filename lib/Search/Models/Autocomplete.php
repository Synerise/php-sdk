...
class Autocomplete implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new Autocomplete and sets the default values.
    */
     ...
     * @return Autocomplete
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): Autocomplete {
