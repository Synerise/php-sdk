...
class AutocompleteResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<Autocomplete>|null $data A page of matching items as objects. The parameters of each item's object depend on the configuration of displayable attributes.
    */
    private ?array $data = null;
    
    /**
     * @var AutocompleteResponse_extras|null $extras Additional information
    */
    private ?AutocompleteResponse_extras $extras = null;
    ...
    */
    ...
    /**
     * Instantiates a new AutocompleteResponse and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AutocompleteResponse {
    ...
    */
     ...
     * @return array<Autocomplete>|null
    */
     ...
     * @return AutocompleteResponse_extras|null
    */
    public function getExtras(): ?AutocompleteResponse_extras {
        return $this->extras;
    }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'data' => fn(ParseNode $n) => $o->setData($n->getCollectionOfObjectValues([Autocomplete::class, 'createFromDiscriminatorValue'])),
            'extras' => fn(ParseNode $n) => $o->setExtras($n->getObjectValue([AutocompleteResponse_extras::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @param array<Autocomplete>|null $value Value to set for the data property.
    */
     ...
     * @param AutocompleteResponse_extras|null $value Value to set for the extras property.
    */
    public function setExtras(?AutocompleteResponse_extras $value): void {
        $this->extras = $value;
    }
