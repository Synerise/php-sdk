...
*/
class ListingResponse_extras implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ListingResponse_extras and sets the default values.
    */
     ...
     * @return ListingResponse_extras
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ListingResponse_extras {
        return new ListingResponse_extras();
    }
