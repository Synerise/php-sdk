...
*/
class FullTextSearchResponseWithExplanation_extras implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new FullTextSearchResponseWithExplanation_extras and sets the default values.
    */
     ...
     * @return FullTextSearchResponseWithExplanation_extras
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): FullTextSearchResponseWithExplanation_extras {
        return new FullTextSearchResponseWithExplanation_extras();
    }
