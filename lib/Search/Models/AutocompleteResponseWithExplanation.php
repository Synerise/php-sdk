...
class AutocompleteResponseWithExplanation implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var AutocompleteResponseWithExplanation_extras|null $extras Additional information
    */
    private ?AutocompleteResponseWithExplanation_extras $extras = null;
    ...
    */
    ...
    /**
     * Instantiates a new AutocompleteResponseWithExplanation and sets the default values.
    */
     ...
     * @return AutocompleteResponseWithExplanation
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AutocompleteResponseWithExplanation {
        return new AutocompleteResponseWithExplanation();
    }
    ...
    */
     ...
     * @return AutocompleteResponseWithExplanation_extras|null
    */
    public function getExtras(): ?AutocompleteResponseWithExplanation_extras {
        return $this->extras;
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'extras' => fn(ParseNode $n) => $o->setExtras($n->getObjectValue([AutocompleteResponseWithExplanation_extras::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @param AutocompleteResponseWithExplanation_extras|null $value Value to set for the extras property.
    */
    public function setExtras(?AutocompleteResponseWithExplanation_extras $value): void {
        $this->extras = $value;
    }
