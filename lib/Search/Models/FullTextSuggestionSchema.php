...
*/
class FullTextSuggestionSchema implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new FullTextSuggestionSchema and sets the default values.
    */
     ...
     * @return FullTextSuggestionSchema
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): FullTextSuggestionSchema {
        return new FullTextSuggestionSchema();
    }
