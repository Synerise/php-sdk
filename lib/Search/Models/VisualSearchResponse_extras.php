...
*/
class VisualSearchResponse_extras implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new VisualSearchResponse_extras and sets the default values.
    */
     ...
     * @return VisualSearchResponse_extras
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): VisualSearchResponse_extras {
        return new VisualSearchResponse_extras();
    }
