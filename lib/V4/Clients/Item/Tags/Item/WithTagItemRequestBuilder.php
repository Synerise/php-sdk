...
namespace Synerise\Api\V4\Clients\Item\Tags\Item;
...
use Synerise\Api\V4\Models\TagAssociation;

/**
 * Builds and executes requests for operations under /clients/{client-id}/tags/{tagID}
*/
class WithTagItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/clients/{client%2Did}/tags/{tagID}');
    ...
    */
     ...
     * @param WithTagItemRequestBuilderPostRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<TagAssociation|null>
     * @throws Exception
    */
    public function post(?WithTagItemRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [TagAssociation::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPostRequestInformation(?WithTagItemRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
