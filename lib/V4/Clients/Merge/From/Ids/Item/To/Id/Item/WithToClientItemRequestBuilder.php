...
namespace Synerise\Api\V4\Clients\Merge\From\Ids\Item\To\Id\Item;
...
/**
 * Builds and executes requests for operations under /clients/merge/from/ids/{fromClientIds}/to/id/{toClientId}
*/
class WithToClientItemRequestBuilder extends BaseRequestBuilder 
{
    /**
     * Instantiates a new WithToClientItemRequestBuilder and sets the default values.
     * @param array<string, mixed>|string $pathParametersOrRawUrl Path parameters for the request or a String representing the raw URL.
     * @param RequestAdapter $requestAdapter The request adapter to use to execute the requests.
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/clients/merge/from/ids/{fromClientIds}/to/id/{toClientId}');
     ...
     * @param WithToClientItemRequestBuilderPostRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<InResponseClientDetails|null>
     * @throws Exception
    */
    public function post(?WithToClientItemRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(?WithToClientItemRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
    ...
    */
    public function withUrl(string $rawUrl): WithToClientItemRequestBuilder {
        return new WithToClientItemRequestBuilder($rawUrl, $this->requestAdapter);
    }
