...
class LoggedInRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @param LoggedInEvent $body The request body
     ...
     * @throws Exception
    */
    public function post(LoggedInEvent $body, ?LoggedInRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(LoggedInEvent $body, ?LoggedInRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
