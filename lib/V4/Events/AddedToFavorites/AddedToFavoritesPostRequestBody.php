...
class AddedToFavoritesPostRequestBody extends EventBase implements Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new AddedToFavoritesPostRequestBody and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AddedToFavoritesPostRequestBody {
        return new AddedToFavoritesPostRequestBody();
    }
