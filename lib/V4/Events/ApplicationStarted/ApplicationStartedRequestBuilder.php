...
namespace Synerise\Api\V4\Events\ApplicationStarted;
...
/**
 * Builds and executes requests for operations under /events/application-started
*/
class ApplicationStartedRequestBuilder extends BaseRequestBuilder 
{
    /**
     * Instantiates a new ApplicationStartedRequestBuilder and sets the default values.
     * @param array<string, mixed>|string $pathParametersOrRawUrl Path parameters for the request or a String representing the raw URL.
     * @param RequestAdapter $requestAdapter The request adapter to use to execute the requests.
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/events/application-started');
    ...
    */
    public function post(ApplicationstartedRequest $body, ?ApplicationStartedRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
        ...
        $errorMappings = [
                ...
                '500' => [HTTP400::class, 'createFromDiscriminatorValue'],
        ];
    ...
    */
     ...
     * @return ApplicationStartedRequestBuilder
    */
    public function withUrl(string $rawUrl): ApplicationStartedRequestBuilder {
        return new ApplicationStartedRequestBuilder($rawUrl, $this->requestAdapter);
    }
