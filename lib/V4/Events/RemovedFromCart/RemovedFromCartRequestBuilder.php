...
class RemovedFromCartRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
    */
    public function post(CartEvent $body, ?RemovedFromCartRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(CartEvent $body, ?RemovedFromCartRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
