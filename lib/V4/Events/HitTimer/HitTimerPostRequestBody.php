...
class HitTimerPostRequestBody extends EventBase implements Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new HitTimerPostRequestBody and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): HitTimerPostRequestBody {
        return new HitTimerPostRequestBody();
    }
