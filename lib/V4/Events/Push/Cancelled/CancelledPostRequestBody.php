...
class CancelledPostRequestBody extends EventBase implements Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new CancelledPostRequestBody and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CancelledPostRequestBody {
        return new CancelledPostRequestBody();
    }
