...
namespace Synerise\Api\V4\Events\Push\Cancelled;
...
*/
class CancelledRequestBuilder extends BaseRequestBuilder 
{
    /**
     * Instantiates a new CancelledRequestBuilder and sets the default values.
     * @param array<string, mixed>|string $pathParametersOrRawUrl Path parameters for the request or a String representing the raw URL.
     * @param RequestAdapter $requestAdapter The request adapter to use to execute the requests.
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/events/push/cancelled');
    ...
    */
     ...
     * @return CancelledRequestBuilder
    */
    public function withUrl(string $rawUrl): CancelledRequestBuilder {
        return new CancelledRequestBuilder($rawUrl, $this->requestAdapter);
    }
