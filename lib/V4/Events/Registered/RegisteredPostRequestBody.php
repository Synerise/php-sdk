...
class RegisteredPostRequestBody extends EventBase implements Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new RegisteredPostRequestBody and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RegisteredPostRequestBody {
        return new RegisteredPostRequestBody();
    }
