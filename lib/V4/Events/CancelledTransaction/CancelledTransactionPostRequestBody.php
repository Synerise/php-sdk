...
class CancelledTransactionPostRequestBody extends EventBase implements Parsable 
{
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CancelledTransactionPostRequestBody {
        return new CancelledTransactionPostRequestBody();
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'params' => fn(ParseNode $n) => $o->setParams($n->getObjectValue([CancelledTransactionPostRequestBody_params::class, 'createFromDiscriminatorValue'])),
        ]);
    }
     ...
     * @return CancelledTransactionPostRequestBody_params|null
    */
    public function getParams(): ?CancelledTransactionPostRequestBody_params {
        return $this->params;
    }
    ...
    */
     ...
     * @param CancelledTransactionPostRequestBody_params|null $value Value to set for the params property.
    */
    public function setParams(?CancelledTransactionPostRequestBody_params $value): void {
        $this->params = $value;
    }
