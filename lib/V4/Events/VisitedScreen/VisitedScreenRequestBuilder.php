...
class VisitedScreenRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @param VisitedScreenEvent $body The request body
     ...
     * @throws Exception
    */
    public function post(VisitedScreenEvent $body, ?VisitedScreenRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(VisitedScreenEvent $body, ?VisitedScreenRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
