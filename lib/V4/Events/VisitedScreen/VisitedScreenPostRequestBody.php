...
class VisitedScreenPostRequestBody extends EventBase implements Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new VisitedScreenPostRequestBody and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): VisitedScreenPostRequestBody {
        return new VisitedScreenPostRequestBody();
    }
