...
class ItemSearchClickEventDataCompat implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ItemSearchClickEventDataCompat and sets the default values.
    */
     ...
     * @return ItemSearchClickEventDataCompat
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ItemSearchClickEventDataCompat {
        return new ItemSearchClickEventDataCompat();
    }
