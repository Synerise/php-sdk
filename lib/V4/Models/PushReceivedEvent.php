...
class PushReceivedEvent extends EventBase implements Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new PushReceivedEvent and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PushReceivedEvent {
