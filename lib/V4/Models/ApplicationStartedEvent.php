...
class ApplicationStartedEvent extends EventBase implements Parsable 
{
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ApplicationStartedEvent {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'params' => fn(ParseNode $n) => $o->setParams($n->getObjectValue([ApplicationStartedEventParams::class, 'createFromDiscriminatorValue'])),
        ]);
    }
     ...
     * @return ApplicationStartedEventParams|null
    */
    public function getParams(): ?ApplicationStartedEventParams {
        return $this->params;
    }
    ...
    */
     ...
     * @param ApplicationStartedEventParams|null $value Value to set for the params property.
    */
    public function setParams(?ApplicationStartedEventParams $value): void {
        $this->params = $value;
    }
