...
*/
class ApplicationStartedEventParams implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ApplicationStartedEventParams and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ApplicationStartedEventParams {
        return new ApplicationStartedEventParams();
    }
