...
class AppearedInLocationEvent extends EventBase implements Parsable 
{
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AppearedInLocationEvent {
        return new AppearedInLocationEvent();
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'params' => fn(ParseNode $n) => $o->setParams($n->getObjectValue([AppearedInLocationEventParams::class, 'createFromDiscriminatorValue'])),
        ]);
    }
     ...
     * @return AppearedInLocationEventParams|null
    */
    public function getParams(): ?AppearedInLocationEventParams {
        return $this->params;
    }
    ...
    */
     ...
     * @param AppearedInLocationEventParams|null $value Value to set for the params property.
    */
    public function setParams(?AppearedInLocationEventParams $value): void {
        $this->params = $value;
    }
