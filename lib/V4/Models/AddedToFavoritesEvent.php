...
class AddedToFavoritesEvent extends EventBase implements Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new AddedToFavoritesEvent and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AddedToFavoritesEvent {
        return new AddedToFavoritesEvent();
    }
