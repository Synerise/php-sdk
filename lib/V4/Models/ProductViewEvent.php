...
class ProductViewEvent extends EventBase implements Parsable 
{
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ProductViewEvent {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'params' => fn(ParseNode $n) => $o->setParams($n->getObjectValue([ProductViewEventParams::class, 'createFromDiscriminatorValue'])),
        ]);
    }
     ...
     * @return ProductViewEventParams|null
    */
    public function getParams(): ?ProductViewEventParams {
        return $this->params;
    }
    ...
    */
     ...
     * @param ProductViewEventParams|null $value Value to set for the params property.
    */
    public function setParams(?ProductViewEventParams $value): void {
        $this->params = $value;
    }
