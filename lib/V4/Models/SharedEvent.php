...
class SharedEvent extends EventBase implements Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new SharedEvent and sets the default values.
    */
     ...
     * @return SharedEvent
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SharedEvent {
