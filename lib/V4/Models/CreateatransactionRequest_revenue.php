...
*/
class CreateatransactionRequest_revenue implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new CreateatransactionRequest_revenue and sets the default values.
    */
     ...
     * @return CreateatransactionRequest_revenue
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CreateatransactionRequest_revenue {
        return new CreateatransactionRequest_revenue();
    }
