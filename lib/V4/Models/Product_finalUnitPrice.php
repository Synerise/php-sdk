...
/**
 * Total final price of the item per unit, including tax and discounts
*/
class Product_finalUnitPrice implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var float|null $amount The price of the items
    */
    ...
    */
    ...
    /**
     * Instantiates a new Product_finalUnitPrice and sets the default values.
    */
     ...
     * @return Product_finalUnitPrice
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): Product_finalUnitPrice {
        return new Product_finalUnitPrice();
    }
    ...
    */
    ...
    /**
     * Gets the amount property value. The price of the items
     * @return float|null
    */
    ...
    */
    ...
    /**
     * Sets the amount property value. The price of the items
