...
class VisitedScreenEvent extends EventBase implements Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new VisitedScreenEvent and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): VisitedScreenEvent {
        return new VisitedScreenEvent();
    }
