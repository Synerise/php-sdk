...
/**
 * The regular price of the items
*/
class RegularUnitPrice implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new RegularUnitPrice and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RegularUnitPrice {
        return new RegularUnitPrice();
    }
