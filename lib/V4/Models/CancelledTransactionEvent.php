...
class CancelledTransactionEvent extends EventBase implements Parsable 
{
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CancelledTransactionEvent {
        return new CancelledTransactionEvent();
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'params' => fn(ParseNode $n) => $o->setParams($n->getObjectValue([CancelledTransactionEventParams::class, 'createFromDiscriminatorValue'])),
        ]);
    }
     ...
     * @return CancelledTransactionEventParams|null
    */
    public function getParams(): ?CancelledTransactionEventParams {
        return $this->params;
    }
    ...
    */
     ...
     * @param CancelledTransactionEventParams|null $value Value to set for the params property.
    */
    public function setParams(?CancelledTransactionEventParams $value): void {
        $this->params = $value;
    }
