...
*/
class AppearedInLocationEventParams implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new AppearedInLocationEventParams and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AppearedInLocationEventParams {
        return new AppearedInLocationEventParams();
    }
