...
*/
class CreateatransactionRequest_value implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new CreateatransactionRequest_value and sets the default values.
    */
     ...
     * @return CreateatransactionRequest_value
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CreateatransactionRequest_value {
        return new CreateatransactionRequest_value();
    }
