...
*/
class ProductViewEventParams implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ProductViewEventParams and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ProductViewEventParams {
        return new ProductViewEventParams();
    }
