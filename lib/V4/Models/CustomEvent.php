...
class CustomEvent extends EventBase implements Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new CustomEvent and sets the default values.
    */
     ...
     * @return CustomEvent
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CustomEvent {
