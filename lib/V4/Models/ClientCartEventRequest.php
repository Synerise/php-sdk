...
class ClientCartEventRequest extends EventBase implements Parsable 
{
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ClientCartEventRequest {
        return new ClientCartEventRequest();
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'params' => fn(ParseNode $n) => $o->setParams($n->getObjectValue([ClientCartEventRequest_params::class, 'createFromDiscriminatorValue'])),
        ]);
    }
     ...
     * @return ClientCartEventRequest_params|null
    */
    public function getParams(): ?ClientCartEventRequest_params {
        return $this->params;
    }
    ...
    */
     ...
     * @param ClientCartEventRequest_params|null $value Value to set for the params property.
    */
    public function setParams(?ClientCartEventRequest_params $value): void {
        $this->params = $value;
    }
