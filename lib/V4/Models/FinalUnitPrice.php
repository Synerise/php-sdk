...
/**
 * Final price per unit. This value must be multiplied by `quantity` and added to `revenue`.
*/
class FinalUnitPrice implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new FinalUnitPrice and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): FinalUnitPrice {
        return new FinalUnitPrice();
    }
