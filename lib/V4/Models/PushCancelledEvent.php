...
class PushCancelledEvent extends EventBase implements Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new PushCancelledEvent and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PushCancelledEvent {
        return new PushCancelledEvent();
    }
