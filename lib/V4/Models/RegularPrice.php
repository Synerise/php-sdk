...
*/
class RegularPrice implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new RegularPrice and sets the default values.
    */
     ...
     * @return RegularPrice
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RegularPrice {
