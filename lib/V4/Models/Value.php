...
/**
 * If you want to display the price without tax, use this object. If you only want to display the total price of the transaction, set the values to the same as in `revenue`.
*/
class Value implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
     ...
     * @return Value
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): Value {
        return new Value();
    }
