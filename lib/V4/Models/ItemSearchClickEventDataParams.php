...
*/
class ItemSearchClickEventDataParams implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ItemSearchClickEventDataParams and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ItemSearchClickEventDataParams {
        return new ItemSearchClickEventDataParams();
    }
