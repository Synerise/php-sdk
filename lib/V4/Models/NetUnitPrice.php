...
*/
class NetUnitPrice implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new NetUnitPrice and sets the default values.
    */
     ...
     * @return NetUnitPrice
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): NetUnitPrice {
        return new NetUnitPrice();
    }
