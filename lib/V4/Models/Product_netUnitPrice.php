...
/**
 * Price before taxation (before or after discounts, depending on your implementation and discount type)
*/
class Product_netUnitPrice implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new Product_netUnitPrice and sets the default values.
    */
     ...
     * @return Product_netUnitPrice
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): Product_netUnitPrice {
        return new Product_netUnitPrice();
    }
