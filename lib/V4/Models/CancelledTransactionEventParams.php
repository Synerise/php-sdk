...
*/
class CancelledTransactionEventParams implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new CancelledTransactionEventParams and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CancelledTransactionEventParams {
        return new CancelledTransactionEventParams();
    }
