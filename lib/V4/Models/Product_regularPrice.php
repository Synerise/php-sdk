...
/**
 * Regular price of the item after taxation, before discounts
*/
class Product_regularPrice implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new Product_regularPrice and sets the default values.
    */
     ...
     * @return Product_regularPrice
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): Product_regularPrice {
        return new Product_regularPrice();
    }
