...
class LastViewedRecommendationCampaignsCreateRequestV2_parameters extends BaseRecommendationsCampaignParameters implements Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new LastViewedRecommendationCampaignsCreateRequestV2_parameters and sets the default values.
    */
     ...
     * @return LastViewedRecommendationCampaignsCreateRequestV2_parameters
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): LastViewedRecommendationCampaignsCreateRequestV2_parameters {
        return new LastViewedRecommendationCampaignsCreateRequestV2_parameters();
    }
