...
class RecentInteractionsRecommendationCampaignsCreateRequestV2 extends BaseRecommendationCampaignsCreateRequestV2 implements Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new RecentInteractionsRecommendationCampaignsCreateRequestV2 and sets the default values.
    */
     ...
     * @return RecentInteractionsRecommendationCampaignsCreateRequestV2
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RecentInteractionsRecommendationCampaignsCreateRequestV2 {
        return new RecentInteractionsRecommendationCampaignsCreateRequestV2();
    }
