...
class VisuallySimilarRecommendationCampaignsCreateRequestV2_parameters extends WithMetricsRecommendationsCampaignParameters implements Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new VisuallySimilarRecommendationCampaignsCreateRequestV2_parameters and sets the default values.
    */
     ...
     * @return VisuallySimilarRecommendationCampaignsCreateRequestV2_parameters
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): VisuallySimilarRecommendationCampaignsCreateRequestV2_parameters {
        return new VisuallySimilarRecommendationCampaignsCreateRequestV2_parameters();
    }
