...
*/
class RecommendationCampaignDefinitionV2Wrapper implements ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
     ...
     * @return RecommendationCampaignDefinitionV2Wrapper
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RecommendationCampaignDefinitionV2Wrapper {
        $result = new RecommendationCampaignDefinitionV2Wrapper();
