...
class PersonalizedRecommendationCampaignsCreateRequestV2 extends BaseRecommendationCampaignsCreateRequestV2 implements Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new PersonalizedRecommendationCampaignsCreateRequestV2 and sets the default values.
    */
     ...
     * @return PersonalizedRecommendationCampaignsCreateRequestV2
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PersonalizedRecommendationCampaignsCreateRequestV2 {
        return new PersonalizedRecommendationCampaignsCreateRequestV2();
    }
