...
class LastViewedRecommendationCampaignsDefinitionV2 extends BaseRecommendationCampaignsDefinitionV2 implements Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new LastViewedRecommendationCampaignsDefinitionV2 and sets the default values.
    */
     ...
     * @return LastViewedRecommendationCampaignsDefinitionV2
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): LastViewedRecommendationCampaignsDefinitionV2 {
        return new LastViewedRecommendationCampaignsDefinitionV2();
    }
