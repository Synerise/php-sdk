...
class CrossSellRecommendationCampaignsCreateRequestV2_parameters extends WithMetricsRecommendationsCampaignParameters implements Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new CrossSellRecommendationCampaignsCreateRequestV2_parameters and sets the default values.
    */
     ...
     * @return CrossSellRecommendationCampaignsCreateRequestV2_parameters
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CrossSellRecommendationCampaignsCreateRequestV2_parameters {
        return new CrossSellRecommendationCampaignsCreateRequestV2_parameters();
    }
