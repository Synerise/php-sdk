...
class AttributeRecommendationCampaignsCreateRequestV2 extends BaseRecommendationCampaignsCreateRequestV2 implements Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new AttributeRecommendationCampaignsCreateRequestV2 and sets the default values.
    */
     ...
     * @return AttributeRecommendationCampaignsCreateRequestV2
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AttributeRecommendationCampaignsCreateRequestV2 {
        return new AttributeRecommendationCampaignsCreateRequestV2();
    }
