...
class SetComplementRecommendationCampaignsDefinitionV2 extends BaseRecommendationCampaignsDefinitionV2 implements Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new SetComplementRecommendationCampaignsDefinitionV2 and sets the default values.
    */
     ...
     * @return SetComplementRecommendationCampaignsDefinitionV2
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SetComplementRecommendationCampaignsDefinitionV2 {
        return new SetComplementRecommendationCampaignsDefinitionV2();
    }
