...
class SectionRecommendationCampaignsDefinitionV2 extends BaseRecommendationCampaignsDefinitionV2 implements Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new SectionRecommendationCampaignsDefinitionV2 and sets the default values.
    */
     ...
     * @return SectionRecommendationCampaignsDefinitionV2
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SectionRecommendationCampaignsDefinitionV2 {
        return new SectionRecommendationCampaignsDefinitionV2();
    }
