 ...
 * Pagination metadata
*/
class RecommendationCampaignsResponseV2_meta implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<RecommendationCampaignsResponseV2_meta_link>|null $link Links to neighboring pages, first page, and last page in pagination
    */
    ...
    */
    ...
    /**
     * @var float|null $totalCount The total number of campaigns
    */
    ...
    */
    ...
    /**
     * Instantiates a new RecommendationCampaignsResponseV2_meta and sets the default values.
    */
     ...
     * @return RecommendationCampaignsResponseV2_meta
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RecommendationCampaignsResponseV2_meta {
        return new RecommendationCampaignsResponseV2_meta();
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'link' => fn(ParseNode $n) => $o->setLink($n->getCollectionOfObjectValues([RecommendationCampaignsResponseV2_meta_link::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @return array<RecommendationCampaignsResponseV2_meta_link>|null
    */
    ...
    */
    ...
    /**
     * Gets the totalCount property value. The total number of campaigns
     * @return float|null
    */
    ...
    */
     ...
     * @param array<RecommendationCampaignsResponseV2_meta_link>|null $value Value to set for the link property.
    */
    ...
    */
    ...
    /**
     * Sets the totalCount property value. The total number of campaigns
