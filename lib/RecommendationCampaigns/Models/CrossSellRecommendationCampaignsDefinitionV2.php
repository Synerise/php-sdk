...
class CrossSellRecommendationCampaignsDefinitionV2 extends BaseRecommendationCampaignsDefinitionV2 implements Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new CrossSellRecommendationCampaignsDefinitionV2 and sets the default values.
    */
     ...
     * @return CrossSellRecommendationCampaignsDefinitionV2
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CrossSellRecommendationCampaignsDefinitionV2 {
        return new CrossSellRecommendationCampaignsDefinitionV2();
    }
