...
class ItemComparisonRecommendationCampaignsCreateRequestV2_parameters extends WithMetricsRecommendationsCampaignParameters implements Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ItemComparisonRecommendationCampaignsCreateRequestV2_parameters and sets the default values.
    */
     ...
     * @return ItemComparisonRecommendationCampaignsCreateRequestV2_parameters
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ItemComparisonRecommendationCampaignsCreateRequestV2_parameters {
        return new ItemComparisonRecommendationCampaignsCreateRequestV2_parameters();
    }
