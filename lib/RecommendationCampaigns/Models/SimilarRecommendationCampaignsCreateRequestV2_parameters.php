...
class SimilarRecommendationCampaignsCreateRequestV2_parameters extends WithMetricsRecommendationsCampaignParameters implements Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new SimilarRecommendationCampaignsCreateRequestV2_parameters and sets the default values.
    */
     ...
     * @return SimilarRecommendationCampaignsCreateRequestV2_parameters
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SimilarRecommendationCampaignsCreateRequestV2_parameters {
        return new SimilarRecommendationCampaignsCreateRequestV2_parameters();
    }
