...
class SimilarRecommendationCampaignsDefinitionV2 extends BaseRecommendationCampaignsDefinitionV2 implements Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new SimilarRecommendationCampaignsDefinitionV2 and sets the default values.
    */
     ...
     * @return SimilarRecommendationCampaignsDefinitionV2
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SimilarRecommendationCampaignsDefinitionV2 {
        return new SimilarRecommendationCampaignsDefinitionV2();
    }
