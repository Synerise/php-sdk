...
class MetricsRecommendationCampaignsDefinitionV2 extends BaseRecommendationCampaignsDefinitionV2 implements Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new MetricsRecommendationCampaignsDefinitionV2 and sets the default values.
    */
     ...
     * @return MetricsRecommendationCampaignsDefinitionV2
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MetricsRecommendationCampaignsDefinitionV2 {
        return new MetricsRecommendationCampaignsDefinitionV2();
    }
