...
/**
 * Builds and executes requests for operations under /recommendations/v2/campaigns/{campaignId}/copy
*/
class CopyRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/recommendations/v2/campaigns/{campaignId}/copy');
     ...
     * @throws Exception
    */
    public function post(?CopyRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(?CopyRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
