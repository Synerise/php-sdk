...
namespace Synerise\Api\RecommendationCampaigns\Recommendations\V2\Campaigns\Item\Item;
...
/**
 * Builds and executes requests for operations under /recommendations/v2/campaigns/{campaignId}/{state}
*/
class WithStateItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/recommendations/v2/campaigns/{campaignId}/{state}');
     ...
     * @throws Exception
    */
    public function post(?WithStateItemRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(?WithStateItemRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
