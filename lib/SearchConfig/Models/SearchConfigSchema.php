...
/**
 * Details of a single index
*/
class SearchConfigSchema implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new SearchConfigSchema and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SearchConfigSchema {
        return new SearchConfigSchema();
    }
