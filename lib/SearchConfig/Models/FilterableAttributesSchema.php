...
*/
class FilterableAttributesSchema implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new FilterableAttributesSchema and sets the default values.
    */
     ...
     * @return FilterableAttributesSchema
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): FilterableAttributesSchema {
        return new FilterableAttributesSchema();
    }
