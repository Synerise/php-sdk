...
*/
class DistinctFilterAttributesSchema implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DistinctFilterAttributesSchema and sets the default values.
    */
     ...
     * @return DistinctFilterAttributesSchema
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DistinctFilterAttributesSchema {
        return new DistinctFilterAttributesSchema();
    }
