...
/**
 * Composed type wrapper for classes AdaptiveMatching, AnyMatching, MaximumNotMatching, MinimumMatching
*/
class FallbackMatching implements ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): FallbackMatching {
        $result = new FallbackMatching();
        return $result;
    }
