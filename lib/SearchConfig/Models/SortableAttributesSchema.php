...
*/
class SortableAttributesSchema implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new SortableAttributesSchema and sets the default values.
    */
     ...
     * @return SortableAttributesSchema
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SortableAttributesSchema {
        return new SortableAttributesSchema();
    }
