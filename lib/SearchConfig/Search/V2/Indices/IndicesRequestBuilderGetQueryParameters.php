...
{
    /**
     * @var bool|null $excludeAbTests Only indices not involved in currently running AB tests will be retrieved.
    */
    public ?bool $excludeAbTests = null;
    ...
    */
    ...
    /**
     * Instantiates a new IndicesRequestBuilderGetQueryParameters and sets the default values.
    ...
    */
    public function __construct(?bool $excludeAbTests = null, ?bool $includeMeta = null, ?int $limit = null, ?string $name = null, ?GetOrderingQueryParameterType $ordering = null, ?int $page = null, ?string $query = null, ?string $sortBy = null) {
        $this->excludeAbTests = $excludeAbTests;
