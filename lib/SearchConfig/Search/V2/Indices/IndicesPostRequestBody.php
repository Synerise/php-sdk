...
class IndicesPostRequestBody implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new IndicesPostRequestBody and sets the default values.
    */
     ...
     * @return IndicesPostRequestBody
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): IndicesPostRequestBody {
        return new IndicesPostRequestBody();
    }
