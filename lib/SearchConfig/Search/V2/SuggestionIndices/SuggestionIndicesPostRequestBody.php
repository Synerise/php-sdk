...
use Synerise\Api\SearchConfig\Models\SuggestionIndices;

class SuggestionIndicesPostRequestBody implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new SuggestionIndicesPostRequestBody and sets the default values.
    */
     ...
     * @return SuggestionIndicesPostRequestBody
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SuggestionIndicesPostRequestBody {
        return new SuggestionIndicesPostRequestBody();
    }
