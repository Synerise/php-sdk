...
namespace Synerise\Api\SearchConfig\Search\V2\SuggestionIndices\Item\State;
...
/**
 * Builds and executes requests for operations under /search/v2/suggestion-indices/{indexId}/state
*/
class StateRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/search/v2/suggestion-indices/{indexId}/state');
