...
namespace Synerise\Api\Uauth\V2\Auth\Login;

use Microsoft\Kiota\Abstractions\BaseRequestBuilder;
use Microsoft\Kiota\Abstractions\RequestAdapter;
use Synerise\Api\Uauth\V2\Auth\Login\Profile\ProfileRequestBuilder;

/**
 * Builds and executes requests for operations under /v2/auth/login
*/
class LoginRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/v2/auth/login');
