...
*/
class SlotError implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var string|null $message Description of the problem
    */
    ...
    */
    ...
    /**
     * Instantiates a new SlotError and sets the default values.
    */
     ...
     * @return SlotError
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SlotError {
